...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#FFF8F2]">
      ...
      <div className="mx-auto max-w-md px-5 pt-16 pb-10 text-center">
        <motion.div
          initial={reduce ? {} : { opacity: 0, scale: 0.92 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.4 }}
          className="mb-7 inline-flex items-center gap-2.5 rounded-full border border-[#F7E3EB] bg-white px-4 py-2 shadow-sm"
        >
        ...
        <motion.h1
          ...
          className="font-heading text-[2.6rem] font-bold leading-[1.1] tracking-tight text-neutral-900 sm:text-5xl"
        >
          Faça seu amor
          <br />
          <span style={{ color: '#FF4D6D' }}>chorar de felicidade</span>{' '}
          <span className="inline-block animate-[heartbeat_1.8s_ease-in-out_infinite]">❤️</span>
        </motion.h1>
        ...
        >
          Crie uma página linda com as melhores memórias de vocês — fotos, datas e uma mensagem que eles nunca vão esquecer.
        </motion.p>
        ...
        >
          <Link
            href="/create"
            className="flex w-full items-center justify-center gap-2.5 rounded-full py-[15px] text-[15px] font-semibold text-white transition-transform active:scale-[0.97]"
            style={{
              background: 'linear-gradient(135deg, #FF4D6D 0%, #E8003E 100%)',
              boxShadow: '0 8px 28px rgba(255,77,109,0.42), 0 2px 6px rgba(255,77,109,0.2)',
            }}
          >
          ...
          <Link
            href="/example"
            className="flex w-full items-center justify-center gap-1.5 rounded-full border border-neutral-200 bg-white py-[13px] text-[13px] font-medium text-neutral-600 transition-colors hover:border-[#FFADC0] hover:text-[#FF4D6D]"
          >
            Ver um exemplo real →
          </Link>
        </motion.div>
      ...
      <div className="relative mx-auto px-6 pb-0" style={{ maxWidth: 340 }}>
        ...
        >
          <motion.div
            ...
            className="absolute -right-5 top-12 z-20 max-w-[158px] sm:-right-9"
          >
            <div
            ...
            >
              <p className="text-[11px] font-semibold leading-snug text-neutral-800">
                "Meu namorado chorou quando viu 😭"
              </p>
          ...
          <motion.div
            ...
            className="absolute -left-5 bottom-28 z-20 max-w-[152px] sm:-left-9"
          >
            <div
    ...
    >
      ...
      <div className="overflow-hidden" style={{ background: '#FFF8F2' }}>
        ...
        >
          ...
          />
          <p className="relative text-[9px] font-semibold uppercase tracking-[0.3em] text-white/65 mb-2">
            nossa história
          </p>
          <h3
          ...
          <p className="relative mt-1 text-[8.5px] text-white/65 uppercase tracking-widest">
            juntos desde 12/06/2019
          </p>
        ...
        <div className="px-3 pt-2.5 pb-1">
          <p className="text-[7.5px] font-bold uppercase tracking-[0.24em] text-[#E89AAE]">
            Nossos momentos
          </p>
        </div>
